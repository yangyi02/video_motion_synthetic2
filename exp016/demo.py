...
class Demo(BaseDemo):
    ...
    def train_unsupervised(self):
        ...
        for epoch in range(self.train_epoch):
            ...
            im_pred, m_mask_f, depth_f, appear_f, conflict_f, attn_f, m_mask_b, depth_b, appear_b, conflict_b, attn_b = \
    ...
    def test_gt_unsupervised(self):
        ...
        for epoch in range(self.test_epoch):
            ...
            if torch.cuda.is_available():
                ...
                gt_depth_f, gt_depth_b = gt_depth_f.cuda(), gt_depth_b.cuda()
            im_pred, m_mask_f, depth_f, appear_f, conflict_f, attn_f, m_mask_b, depth_b, appear_b, conflict_b, attn_b = \
                self.model_gt(im_input_f, im_input_b, gt_motion_label_f, gt_motion_label_b, gt_depth_f, gt_depth_b)
            loss = torch.abs(im_pred - im_output).sum()
