...
class Net(nn.Module):
    def __init__(self, im_height, im_width, im_channel, n_inputs, n_class, m_range, m_kernel):
        ...
        self.conv_depth1 = nn.Conv2d(num_hidden, 1, 3, 1, 1)
        self.conv_depth2 = nn.Conv2d(num_hidden, 1, 3, 1, 1)
    ...
    def forward(self, im_input, im_output):
        ...
        depth = F.sigmoid(self.conv_depth1(x11)) * 2 + F.sigmoid(self.conv_depth2(x11))
