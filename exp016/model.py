...
class Net(nn.Module):
    ...
    def forward(self, im_input_f, im_input_b):
        ...
        return pred, m_mask_f, depth_f, appear_f, conflict_f, attn, m_mask_b, depth_b, appear_b, conflict_b, 1 - attn
...
class GtNet(nn.Module):
    ...
    def forward(self, im_input_f, im_input_b, gt_motion_f, gt_motion_b, depth_f, depth_b):
